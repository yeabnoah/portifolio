            ...
            <div className="hidden lg:block lg:w-1/2 relative">
                ...
                <div className="relative w-full flex items-center justify-center z-10">
                    <div className="text-white p-6">
                        ...
                        <p className="mt-2">Start your journey with us</p>
                    </div>
                </div>
            </div>
                    ...
                    <CardContent className="space-y-3 p-4">
                        <div className="space-y-1">
                            ...
                            <Input
                                ...
                                type="text"
                                className={`h-8 outline-none focus:outline-none ${errors.name ? 'border-red-500' : ''}`}
                            />
                            {errors.name && (
                        ...
                        <div className="space-y-1">
                            ...
                            <Input
                                ...
                                type="email"
                                className={`h-8 outline-none focus:outline-none ${errors.email ? 'border-red-500' : ''}`}
                            />
                            {errors.email && (
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    className={`h-8 outline-none focus:outline-none ${errors.password ? 'border-red-500' : ''}`}
                                />
                                <Button
                                    variant="ghost"
                                    size="icon"
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    className={`h-8 outline-none focus:outline-none ${errors.confirmPassword ? 'border-red-500' : ''}`}
                                />
                            </div>
                        ...
                        <Button className="w-full h-8 mt-2" onClick={signUp} disabled={loading}>
                            {loading ? "Creating account..." : "Create Account"}
                        </Button>
                        <div className="grid grid-cols-2 gap-2 mt-2">
                            <Button
                                variant="outline"
                                className="hover:bg-muted h-8 text-xs"
                            >
                                <svg
